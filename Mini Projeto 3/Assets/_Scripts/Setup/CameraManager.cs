...
public class CameraManager : ScriptableObject
{
   ...
   // public AudioListener audioListener2; // secundária
    ...
    public void UpdateCamera()
    {
        ...
        ToggleFovMode(pressed1, pressed2, pressed3);
    ...
    //{
    public void ToggleFovMode(bool toggleToClose1, bool toggleToFar1, bool toggleTofreeModeCam1) // podia ser um inteiro 1 ou 2 de entrada
    {
        // camera 1
